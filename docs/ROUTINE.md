...
- 🔄 2026-09-14 14:4x 워커 N(sess-0524-8791) 1회차 = ⓐ: 촬영 루프의 `Capture` 바로 앞에서 `BattleOverlay.Instance.WarningActive` 가 꺼질 때까지 프레임을 넘긴다(상한 600 · 기다렸으면 Trace · 상한 뒤에도 돌면 «ⓑ 후보» 자국) · 게임 코드 0줄. 판정은 다음 런 `ui_score --score`(물고 찍힌 화면 0개 · gear-detail 3.2 위로).
