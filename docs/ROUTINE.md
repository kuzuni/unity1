...
- 범위: `Assets/Scripts/Game/Ui/SkillSummonResult.cs`(**T179 lock 뒤**) · `Assets/Forge/Resources/SummonFxUi.json`(T179 표 · `seq` 절 · 그 lock 뒤) · `Assets/Scripts/Core/Ui/SummonSeqRules.cs`(새 · 상태 조건·시각 · UnityEngine 0) · `Assets/Tests/EditMode/`·`Assets/Tests/PlayMode/`(새 파일)
