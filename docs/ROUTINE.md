...
### T372 — 「모든 장비의 목록」 칸 아래 «0.0000%» 가 **칸 피치보다 넓어 스물다섯이 한 줄로 붙는다**: 정본 `.56rem` 을 하한 `Sub`(36) 로 찍는다 (Game·UI · T136 과 같은 갈래(다른 자리) · 검수 Q 등재 · 런 620 실측)
...
- 범위: `Assets/Scripts/Game/Ui/ForgeInfoPopup.cs`(한 줄) · `Assets/Forge/catalog.json`(필요하면 종류 한 칸 · 남의 lock 이면 T65 꼴로 제 표) · `Assets/Tests/PlayMode/TextSizeGateTests.cs` · `docs/ROUTINE.md`(§1 하한 예외 줄).
