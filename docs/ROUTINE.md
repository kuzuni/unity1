...
### T357 — 포스트(비네트·색 보정)가 **앱 캔버스까지** 물들인다: 정본은 `#game-area`·`#game3d` **안에만** 건다 (Game·UI · **T341 ✅ 가 남긴 자리** · T28 55회차 등재 · 런 508·528·537 실측)
...
- 범위: 촬영·렌더 경계를 쥔 자리(`Assets/Settings/ForgeVolume.asset` 이 아니라 **카메라·캔버스 쪽** — T341 2회차가 바꾼 파일) · `Assets/Tests/PlayMode/`(새 파일 하나). ⚠ 그 파일에 산 lock 이 있으면 그 뒤.
