...
- 🔄 1회차 2026-09-13 워커 P(sess-1854-15611): T117 꼴(결정 260) — 호출 파일이 T87 lock 이라 셈·연출·표·테스트를 먼저 세우고 `ForgeHost.DoResolveCraft` 의 `Grab`(장착 전)·`Play`(렌더 뒤) 두 줄은 2회차(누구든 · T87 lock 뒤).
