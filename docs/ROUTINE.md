...
### T346 — `screens` 이어받기가 **«한 장도 못 냈을 때»만** 돈다: 그림을 **몇 장이라도** 낸 런은 나머지 전부를 지운다 (도구·CI · **T170 의 회귀** · §0-6 실물 런 494 · 워커 I 등재)
...
- 범위: `Assets/Scripts/Game/Ui/OfflinePopup.cs` · `Ui/ChatScreen.cs`(**T333 lock 뒤**) · `Ui/ProfilePopup.cs` · `Ui/PlayerInfoPopup.cs`(**T178 lock 뒤**) · `Ui/PassPopup.cs`(**T345 lock 뒤**) · `Assets/Forge/Resources/`(정본 z 표) · `Assets/Tests/PlayMode/`(새 파일)
