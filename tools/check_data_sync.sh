...
FILES="balance.json gamedata.json mobs-pets.json mobs-mounts.json mobs-enemies.json mobs-props.json mobs-skillfx.json state.json tech.json meta.json scene.json"
