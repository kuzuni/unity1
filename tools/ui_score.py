...
MEASURED_NOTES = {
    ...
    u"ascend": u"카드 상자는 **다 쟀고 맞다**(T28 142회차 · 런 1209 · 앱 상자 기준): 카드 위끝 원작 28.93 ↔ 클론 28.75%H · 높이 39.01 ↔ 39.27 · 폭 73.49 ↔ 73.70%W · "
               u"줄 넷 높이 3.40 ↔ 3.49 · 피치 5.10 ↔ 5.21 · 안내 두 줄·닫기 버튼·카드 아래끝 전부 **±0.5%p 안**이다. 남은 것은 **제목 글자 하나**(T478). "
               u"🚫 **이 화면의 원작 짝은 `ref/shots/` 기기 샷이다(430×860 · 위아래 레터박스 48px)** — `app_box` 를 끝점으로 읽으면 밑변이 6.7% 작아져 «카드가 −2.35%H 짧다» 는 없는 결함이 난다. 반드시 `app_rel()` 로 재라",
