...
MEASURED_NOTES = {
    ...
    u"craft-compare": u"버튼 줄을 쟀고 **T485 로 등재했다**(T28 149회차 · 런 1243): 버튼 바깥 폭 원작 27.9 ↔ 클론 **24.6%W**(정본 셈 27.3) · "
                      u"카드 흰 벽 → 회색 패널 원작 7px ↔ 클론 **14px**(정본 ≈.25rem+테) · 패널 → 버튼 원작 11px ↔ 클론 **24px**(정본 .96rem) — "
                      u"카드 층 `Column` 의 좌우 패딩에 `.cmp-wrap` 의 위 마진 .5rem 이 새고, 회색 패널에 정본에 없는 .4rem 패딩이 있다. "
                      u"틈 1.3rem · 버튼 높이 6.73 ↔ 6.77%H · 카드 위끝(자)은 맞다. "
