...
MEASURED_NOTES = {
    ...
    u"dungeon-detail": u"카드는 맞고 **버튼 한 덩어리만 남았다**(T28 145회차 · 런 1219 · T481 등재): 카드 폭 원작 69.28 ↔ **69.63%W** · 위끝 40.79 ↔ **40.94%H** · "
                        u"보상 알약 폭 54.42 ↔ **54.07%W** — 셋 다 ±0.4 안이다. 어긋난 것은 버튼 — 바깥 상자 원작 **7.80%H** ↔ 클론 **6.35**(−19%)이고 라벨 줄 피치는 반대로 원작 1.162 ↔ 클론 **1.484rem**(+28%)다. "
                        u"⚠ **상쇄다** — 글자가 크고 상자가 작다. 글자만 줄이면 상자가 휑해져 더 멀어진다. "
