...
KNOWN = {
    ...
    'Ui/ForgeUi.cs$cell_shadow_2': 'T371 1회차 — 장비 셀 시대색 광(정본 8538 62% · 7730 의 55% 는 뒤 규칙이 덮어 안 그려진다) · **T331 이 그 겹을 세운 뒤**(11회차 실측: check_box_shadows 의 «아직 안 본» 15 에 8539 가 있다 — lock 이 아니라 일이 막는다)',
    'Ui/PetPanel.cs$pet_tile_shadow_2': 'T371 1회차 — 펫 타일 그림자(정본 8124 가 4288 을 덮는다 · 값은 둘 다 60%) · **T331 이 그 겹을 세운 뒤**(11회차 실측: check_box_shadows 의 «아직 안 본» 15 에 8131 이 있다 — lock 이 아니라 일이 막는다)',
}
