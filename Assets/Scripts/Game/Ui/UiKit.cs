...
namespace Forge.Game.Ui
{
    ...
    /// </summary>
    public enum TextKind { Title, Button, Body, Sub, Micro, Head, Title2 }   // Head — T391 ⓐ: 정본 1.22~1.5rem(≈48px) «하한 위·제목 아래» 단 · Title2 — T404 ⓐ: 정본 모달 제목 1.12~1.2rem(≈42px) 단(카탈로그 textKinds)
