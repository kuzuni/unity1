...
namespace Forge.Tests
{
    ...
    public class ShadowRulesTests
    {
        ...
        public void 표는_정본_자리를_그대로_쥔다()
        {
            ...
            ShadowTable t = T();
            Assert.AreEqual(15, t.Count, "자(check_box_shadows)가 세는 자리와 같은 수여야 한다");
        ...
        public void 딱딱한_턱과_흐린_그림자로_갈린다()
        {
            ...
            Assert.AreEqual(9, soft, "흐린 그림자 — 상단바·자동 제련 카드·자동 낙하·묶음 카드·패스 카드·리그 발판·장비 교체 + 자동 제련 하위 행·보상 앵커(26회차)");
